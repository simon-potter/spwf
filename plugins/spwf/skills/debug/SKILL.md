...
name: debug
description: Pre-phase entry point for bugs — Accepts a Jira ticket or freeform description, runs systematic root-cause investigation (no fixes), forms a written hypothesis, and produces todo/BUG-{slug}.md ready for /spwf:challenge. Investigation happens before any fix is attempted. Use whenever an issue occurs.
