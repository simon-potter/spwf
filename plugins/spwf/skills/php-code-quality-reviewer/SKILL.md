...
| `spwf:simplify` | Language-agnostic dead code removal | Quick pass on any changed file |
...
Flag injection, XSS, and access control issues. For deeper SQL injection analysis, direct the user to `/spwf:security-scan`.
...
- Run `/spwf:php-code-simplifier` to apply safe refactors
- For SQL injection deep review: `/spwf:security-scan`
